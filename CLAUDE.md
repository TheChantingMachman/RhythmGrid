...
- **Current version:** v3.4.0 (adds `deps` command — transitive forward dependency query via `--id`; YAML round-trip self-heal to canonical format; usage grouped by read/write capability).
