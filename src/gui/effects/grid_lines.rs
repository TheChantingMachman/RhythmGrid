...
impl GridLines {
    pub fn new() -> Self {
        GridLines { beat: 0.0, presence: 0.0, presence_beat: 0.0, centroid: 0.0 }
    }
}
...
impl AudioEffect for GridLines {
    ...
    fn render(&self, verts: &mut Vec<Vertex>, indices: &mut Vec<u32>, ctx: &RenderContext) {
        ...
        let c = self.centroid;
        let lc_r = (40.0 + (1.0 - c) * 25.0) as u8;
        let lc_g = 45u8;
        let lc_b = (70.0 + c * 30.0) as u8;
        ...
        let thickness = 0.02 + self.presence_beat * 0.03;
